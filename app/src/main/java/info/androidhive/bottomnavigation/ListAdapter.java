...
public class ListAdapter extends ArrayAdapter<Subject> {
    ...
    public ListAdapter(Context context, int id, List<Subject> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.SubjectName = (TextView) convertView.findViewById(R.id.NameTextView);

            holder.SubjectFullForm = (TextView) convertView.findViewById(R.id.PriceTextView);
        ...
        holder.checkbox.setChecked(subject.getCheckedState());
    ...
    private class SubjectDataFilter extends Filter
    {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            {
                ArrayList<Subject> arrayList1 = new ArrayList<>();
